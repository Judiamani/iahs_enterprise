...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
     ...
     <div class="row mt-5" style="margin-left: 50px; margin-right: 50px; background-color: gold">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body table-responsive p-0" >
                <?php
                  ...
                  if (!empty($email) || !empty($password) || !empty($fonct)) {
                    $host = "localhost";
                  ...
                  echo '<th class="thliste">Fonction</th>';
                  ...
                  echo '<td class="tdliste">' . $donnees['fonct'] . '</td>';
                  echo '<td class="tdliste">' . $donnees['comment'] . '</td>';
                 
                 
                  echo "<td><a href='file5.php?id_news=" . $donnees['id_news'] . "'><i class=\"fas fa-trash\"  style=\"color: blue\"></i></a></td>";
                  echo '</tr>';
                  echo '</form>';
