...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Demandes de service</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <!-- Main content -->
     ...
     <div class="row mt-5" style=" margin-left: 50px; margin-right: 50px">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><strong> Demandes_Entreprises </strong></h3>
              ...
              <!-- /.card-header -->
              <div class="card-body table-responsive p-0" style="background-color: #66e0ff">
                <?php
                  try   //Connection a la bdd
                  {
                  ...
                  if (!empty($nom) || !empty($mail) || !empty($contact)) {
                    $host = "localhost";
                  ...
                  echo '<th class="thliste">Noms</th>';
                  echo '<th class="thliste">Email</th>';
                  echo '<th class="thliste">Contacts</th>';
                  echo '<th class="thliste">Catégories</th>';
                  echo '<th class="thliste">Besoins</th>';
                  ...
                  echo '<td class="tdliste">' . $donnees['mail'] . '</td>';
                  echo '<td class="tdliste">' . $donnees['contact'] . '</td>';
                  echo '<td class="tdliste">' . $donnees['cat'] . '</td>';
                  echo '<td class="tdliste">' . $donnees['besoin'] . '</td>';
                 
                  echo "<td><a href='file4.php?id_ent=" . $donnees['id_ent'] . "'><i class=\"fas fa-trash\"  style=\"color: red\"></i></a></td>";
                  echo '</tr>';
                  echo '</form>';
     ...
     <div class="row mt-5" style=" margin-left: 50px; margin-right: 50px">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><strong> Demandes_Particuliers </strong></h3>
              ...
              <!-- /.card-header -->
              <div class="card-body table-responsive p-0" style="background-color: #66ff99">
                <?php
                  try   //Connection a la bdd
                  {
                    $bdd = new PDO('mysql:host=localhost;dbname=iahs;charset=utf8', 'iahsconnect', 'iahsconnect@727');
                  ...
                  $reponse = $bdd->query('SELECT * FROM particulier');
                  ...
                  echo '<th class="thliste">Noms</th>';
                  echo '<th class="thliste">Prénoms</th>';
                  echo '<th class="thliste">Contacts</th>';
                  echo '<th class="thliste">Catégories</th>';
                  echo '<th class="thliste">Besoins</th>';
                  echo '<th class="thliste">Actions</th>';
                  ...
                  echo "<td><a href='file3.php?id_part=" . $donnees['id_part'] . "'><i class=\"fas fa-trash\"  style=\"color: red\"></i></a></td>";
                  echo '</tr>';
                  echo '</form>';
