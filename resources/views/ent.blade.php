...
<br><br>
<div class="service">
		<h2 style="text-align: center">Entretien bâtiment</h2>
    ...
    <br><br>
		...
		<div class="row">
			<p class=" col-lg-8">
      Effectue la maintenance et l'entretien des locaux et espaces à usage collectif (locaux communaux, établissements hospitaliers, maisons de retraite, immeubles, écoles, locaux d'entreprises,...) selon les règles de sécurité. Peut gérer les approvisionnements d'outils et de consommables. L’agent de maintenance des bâtiments est responsable de l’activité des équipements et bâtiments d’une entreprise. Il a la charge du confort et de la sécurité des occupants. Divers taches de maintenances lui sont attribuées : éclairage, plomberie et du mobilier.
			</p>
			<div class="img_div col-lg-4">
					<a href="ent1.jpg" class="gallery img-responsive ens1" title="The caption 1">
					  <img src="ent1.jpg" width="200" height="135" />  
					</a>
			</div>
		</div><br><br><br>
		...
		<div class='row'>
			<div class="img_div col-lg-4">
					<a href="ent2.jpg" class="gallery img-responsive ens1" title="The caption 1">
					  <img src="ent2.jpg" width="200" height="135" />  
					</a>
			</div>
			<p class=" col-lg-8">
     Poterat longe certamen pertinax cunctorum quorum rati eum cum gestu longe tutela certamen 
      ...
      Poterat longe certamen pertinax cunctorum quorum rati eum cum gestu longe tutela certamen 
			...
			<div class="img_div col-lg-4">
				<a href="ent3.jpeg" class="gallery img-responsive ens1" title="The caption 1">
				  <img src="ent3.jpeg" width="200" height="135" />  
				</a>
			</div>
		</div>
