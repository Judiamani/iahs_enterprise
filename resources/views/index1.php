  ...
  **/
  function allow(){
    global $PDO;
        ...
        $req->execute();
        $data = $req->fetchAll();
        if($_SESSION['email']!='judicaelamani@gmail.com'){
          header("Location: index4.php");
        }
  }
}   
$Auth = new Auth();
$Auth->allow($_SESSION['email']);
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content" style="width: 1400px">
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info" style="height: 150px" >
              ...
              <a href="./index3.php" class="small-box-footer">En savoir plus <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success" style="height: 150px" >
              ...
              <a href="./index2.php" class="small-box-footer">En savoir plus<i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger" style="height: 150px" >
              <div class="inner">
                ...
                <p>Contacts visiteurs</p>
              </div>
              <div class="icon">
                <i class="ion ion-pie-graph"></i>
              </div>
              <a href="./index6.php" class="small-box-footer">En savoir plus<i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div><br><br>
      ...
      <div style="margin-left: 100px"> 
        <img src="dist/img/wel1.gif" alt="welcome" style="height: 100px" title="Welcome User" >
        <img src="dist/img/home.gif" alt="home" style="width: 500px; height: 300px; margin-left: 80px" title="Admin Space" class="img-size-55 mr-3 img-circle" >
      </div>
            <!-- /. box -->
          </div>
    <!-- /.content -->
