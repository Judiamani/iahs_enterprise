...
<h2 style="text-align: center">Publications</h2><br><br><br>
  ...
  border-width: 5px">
          ...
          <div class="card-body">
          Ouverture des magasins de stockage à San-Pédro <i class="fas fa-eye" style="margin-left: 20px"><span id="counterValue"></span></i>
            <p>
  ...
  border-width: 5px">
          ...
          <div class="card-body">
          Sponsorisation du parc de véhicules à Issia <i class="fas fa-eye" style="margin-left: 20px"><span id="counterValue1"></span></i>
            <p>
				18/05/2019 - IAHS Admin
		    </p>
  ...
  border-width: 5px">
          ...
          <div class="card-body">
          Parténariat avec Bouygues Telecoms <i class="fas fa-eye" style="margin-left: 20px"><span id="counterValue2"></span></i>
            <p>
				18/05/2019 - IAHS Admin
		    </p>
  ...
  border-width: 5px">
          ...
          <div class="card-body">
          Parténariat avec Bouygues Telecoms <i class="fas fa-eye" style="margin-left: 20px"><span id="counterValue3"></span></i>
            <p>
				18/05/2019 - IAHS Admin
		    </p>
