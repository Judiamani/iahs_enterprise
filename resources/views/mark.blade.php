...
<div class="service">
     ...
     <a style="margin-left: 15px;" target = "_self" href="{{ url('/service') }}"> <button type="submit" name="submit" value="Add" class="save btn btn-primary"><i class="fas fa-save" style="margin-left: 15px; padding-right: 15px"></i>Passez une demande ici</button></a>
    <br><br>
