...
<br><br>
<div class="service">
		<h2 style="text-align: center">Import-Export</h2>
    ...
    <br><br>
		...
		<div class="row">
			<p class=" col-lg-8">
      Le commerce international est l'échange de biens, de services et capitaux entre pays.
      Ce type de commerce existe depuis des siècles (cf. route de la soie), mais il connaît 
      un nouvel essor du fait de la mondialisation économique.
      La théorie du commerce international est la branche de l'économie qui étudie et modélise 
      le commerce international. Par ailleurs il existe un « droit des opérations de commerce 
      international », formalisé notamment par les incoterms de la Chambre de commerce internationale.
			</p>
			<div class="img_div col-lg-4">
					<a href="imark7.jpg" class="gallery img-responsive ens1" title="The caption 1">
					  <img src="imark7.jpg" width="200" height="135" />  
					</a>
			</div>
		</div><br><br><br>
		...
		<div class='row'>
			<div class="img_div col-lg-4">
					<a href="imark8.jpg" class="gallery img-responsive ens1" title="The caption 1">
					  <img src="imark8.jpg" width="200" height="135" />  
					</a>
			</div>
			<p class=" col-lg-8">
      Poterat longe certamen pertinax cunctorum quorum rati eum cum gestu longe tutela certamen 
		...
		<div class="row">
			<p class=" col-lg-8">
        Nous importons plusieurs produits de toutes les contrees. Mais l'accès en mis sur les produits africains.
        Ainsi nous contactons des fournisseurs internationamemt reconnus, qui mettront a votre disposition des 
        produits alimentaires, les appareils et technologies diverses.
			</p>
			<div class="img_div col-lg-4">
				<a href="imark9.png" class="gallery img-responsive ens1" title="The caption 1">
				  <img src="imark9.png" width="200" height="135" />  
				</a>
			</div>
		</div>
