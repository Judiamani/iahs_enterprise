...
<head>
    ...
    <style type="text/css">
    	/* Coded with passion by Koffi Judicaël AMANI */
		body,
		html {
			margin: 0;
			padding: 0;
              ...
              <button type="submit" name="submit" class="btn login_btn">Se connecter</button>
				...
				<div class="mt-4">
					<div class="d-flex justify-content-center links">
						<h6>Vérifiez que vos identifiants sont corrects</h6>
					</div>
					<div class="d-flex justify-content-center links">
						...
						<?php
				            ...
				            if (isset($_GET["newpwd"])) {
				              if ($_GET["newpwd"] == "passwordupdated") {
				                echo '<p class="signupsucces">Votre mot de passe a été récupéré!</p>';
				              }
				            }
